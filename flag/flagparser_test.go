...
func TestParse(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: map[string]string{
				"gonfig.foo.name1.bar.name2.value": "bar",
			},
		},
		{
		...
		},
		{
			...
			expected: map[string]string{
				"gonfig.foo.caseSensitiveName": "barBoo",
			},
		},
		{
			...
			expected: map[string]string{
				"gonfig.foo.Name1.bar.name2.value": "secondValue",
			},
		},
		{
		...
		},
		{
			...
			expected: map[string]string{
				"gonfig.foo.default.bar.fuu": "true",
			},
		},
		{
